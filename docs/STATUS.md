...
## Next up
0. **Next:** v0.1.0 is out (2026-09-24). SignPath Foundation applied for 2026-09-24 (reply in one to two weeks to info@teispace.com; then wire signing, RELEASING.md step 6). M6-04: ghcr.io image and Homebrew tap done; winget waits on the maintainer (first submission, `WINGET_TOKEN`, RELEASING.md step 7). Then: watch the issue tracker for beta reports; apt/dnf repository later.
