...
## Next up
0. **Next:** v0.1.0 is out (2026-09-24). SignPath Foundation applied for 2026-09-24 (reply in one to two weeks to info@teispace.com; then wire signing, RELEASING.md step 6). Now: M6-04 channels (Homebrew cask, winget, ghcr.io image). Watch the issue tracker for beta reports.
