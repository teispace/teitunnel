...
## Next up
0. **Next:** a signed dry run from `main` (Actions ▸ Release ▸ Run workflow), check the notarized DMG, then merge release-please's "chore: release 0.1.0" PR (#8) to publish v0.1.0. Afterwards: Enforce HTTPS on Pages, SignPath application.
