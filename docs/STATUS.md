...
## Next up
1. M5 rest: Activity diff / copy-as-command / re-verify (M5-04), Doctor-error notifications (M5-07), menu bar Disable per route, Overview top routes by traffic, binary update with Always-on connectors, systemd/Task Scheduler adapter stubs.
