...
- [ ] M12-04 protection: edge rules (D-105) and service tokens (D-106) done; Lens gates in the UI done (Quick Share shield); login presets and Access webhook bypass left
