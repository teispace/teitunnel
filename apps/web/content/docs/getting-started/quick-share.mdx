...
description: Get a temporary public URL for anything running on your computer.
---

A **Quick Share** gives a service on your computer a random public URL on
...
It's a real route on this machine's tunnel, made and removed through the same reviewed-plan
