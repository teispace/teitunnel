...
description: Move routes from a cloudflared config.yml (a locally-managed tunnel) onto Teitunnel, previewed and reversible.
---
...
2. Pick the routes to import and **Review**. They're added to this machine's tunnel in one
...
**Tunnels ▸ Also on this machine** and can stop it for you.
