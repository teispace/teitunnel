...
hostname from several machines on purpose, use [load balancing](/docs/guides/load-balancing)).
...
teitunnel route remove beta.example.com          # finds the tunnel by itself
